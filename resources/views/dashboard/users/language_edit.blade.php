    ...
    <div class="row  justify-content-center pt-5">
       <div class="col-sm-6 col-md-6 col-md-offset-1 mt-4">
        <div class="entry-content pb-1  px-3 bg-white my-3 shadow">
            <form method="POST" class="" action="{{route('languages.update' , $lang->id)}}" enctype="multipart/form-data" autocomplete="off">
                @csrf
                @method('PUT')
                    ...
                    <div class ="row">
                        <div class=" col-md-6">
                          ...
                          <select id="inputState" class="form-control"  name = "language">
                             ...
                             <option  selected value="{{$lang->language}}" > {{ $lang->language }} </option>
