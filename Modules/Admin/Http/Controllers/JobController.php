...
class JobController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin::dashboard.admins.owners.jobs',compact('jobs'));
    }
    ...
    public function create($id)
    {
        ...
        return view('admin::dashboard.admins.owners.addNewJob',
    ...
    public function edit($id)
    {
        ...
        return view('admin::dashboard.admins.owners.job_edit',
