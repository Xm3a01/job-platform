 <?php
    ...
    Route::resource('educations', 'Dashboard\User\EducationController')->except('index' , 'show' , 'create');
    Route::resource('languages', 'Dashboard\User\LanguageController')->except('index' , 'show' , 'create');
