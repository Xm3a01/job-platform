...
class AboutController extends Controller
{
    ...
    public function index()
    {
      $all = About::all();
       ...
       return view('admin::dashboard.admins.profile.about-company' , compact('all'));
    }
     public function indexpartner()
    {
      ...
      return  view('admin::dashboard.admins.profile.partnersSuccess' , compact(['parteners','about']));
    }
    /**
    ...
    {
        $about = About::latest()->take(1)->first();
       return view('admin::dashboard.admins.profile.about-company', compact(['about']));
    }
     ...
     public function createTeam()
    {
       ...
       return    view('admin::dashboard.admins.profile.team', compact('employees','about'));
    }

    public function createContact()
    {
        $about = About::latest()->take(1)->first();
       return view('admin::dashboard.admins.profile.contactus',compact('about'));
    }

    public function createPartner()
    {
        $about = About::latest()->take(1)->first();
       return view('admin::dashboard.admins.profile.partnersSuccess',compact('about'));
    }

    public function createwhyUs()
    {
        $about = About::latest()->take(1)->first();
       return view('admin::dashboard.admins.profile.whychooseUs',compact('about'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin::dashboard.admins.profile.about_edit',compact('about'));
    }
     ...
     public function edit_partner($id)
     {
        ...
        return  view('admin::dashboard.admins.profile.partener_edit',compact('partener'));
     }
    ...
    public function edit_team($id)
    {
        ...
        return  view('admin::dashboard.admins.profile.team_edit',compact('emp'));
    }
