...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin::dashboard.admins.users.index',compact(['roles' , 'cities','countries', 'users', 'sub_specials', 'levels','specials']));
    }
    ...
    public function index_edu()
    {
        ...
        $specials = Special::all();
        $levels = Level::all();
        return view('admin::dashboard.admins.users.education.index',compact(['educations','roles' , 'cities','countries', 'sub_specials', 'levels','specials']));
    }
    ...
    public function index_lang()
    {
        ...
        $sub_specials = SubSpecial::all();
        $levels = Level::all();
        return view('admin::dashboard.admins.users.language.index',compact(['languages','roles' , 'cities','countries', 'sub_specials', 'levels']));
    }
    ...
    public function index_ref()
    {
        ...
        $refs =Reference::all();
        $refs->load('user');
        return view('admin::dashboard.admins.users.ref.index',compact('refs'));
    }
    ...
    public function index_attch()
    {
        ...
        $files->load('user');
        // return $files;
        return view('admin::dashboard.admins.users.attch.index',compact('files'));
    }
    ...
    public function create($id)
    {
        ...
        return view('admin::dashboard.admins.users.language.create',compact('user'));
    }
    ...
    public function createEdu($id)
    {
        ...
        $specials = Special::all();
        $levels = Level::all();
        return view('admin::dashboard.admins.users.education.create',compact(['roles' , 'cities','countries', 'user', 'sub_specials', 'levels','specials']));
    }

    public function createRef($id)
    {
        $user = User::findOrFail($id);
        return view('admin::dashboard.admins.users.ref.create',compact('user'));
    }

    public function createAttch($id)
    {
        $user = User::findOrFail($id);
        return view('admin::dashboard.admins.users.attch.create',compact('user'));
    }
    ...
    public function edit($id)
    {
        ...
        $sub_specials = SubSpecial::all();
        $specials = Special::all();
        return view('admin::dashboard.admins.users.edit', compact(['roles' , 'cities','countries', 'user', 'sub_specials','specials']));
    }
    ...
    public function edu_edit($id)
    {
        ...
        return view('admin::dashboard.admins.users.education.edit', compact(['education','roles' , 'cities','countries', 'user', 'sub_specials']));
    }
    ...
    public function lang_edit($id)
    {
        ...
        $language->load('user');
        return view('admin::dashboard.admins.users.language.edit', compact(['language','roles' , 'cities','countries', 'user', 'sub_specials','specials']));
    }
    ...
    public function ref_edit($id)
    {
        ...
        $ref->load('user');
        return view('admin::dashboard.admins.users.ref.edit', compact('ref'));
    }
    ...
    public function attch_edit($id)
    {
        ...
        $file->load('user');
        return view('admin::dashboard.admins.users.attch.edit', compact('file'));
    }
    ...
    public function guid() {
        ...
        // return view('admin::dashboard.users.guid' , compact('guid'));
