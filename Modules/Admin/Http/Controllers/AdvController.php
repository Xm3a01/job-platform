...
class AdvController extends Controller
{
    ...
    {
        $advs = Adv::all();
        return view('admin::dashboard.admins.ads.index',compact('advs'));
    }

    public function price_index()
    {
        $prices = Princing::all();
        return view('admin::dashboard.admins.ads.pricing',compact('prices'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin::dashboard.admins.ads.edit',compact('adv'));
    }

    public function price_edit($id)
    {
        $price = Princing::findOrFail($id);
        return view('admin::dashboard.admins.ads.pricing_edit',compact('price'));
    }
