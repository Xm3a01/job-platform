...
class SubSpecialController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin::dashboard.admins.process.sub_special.index', compact(['sub_specials','specials']));
    }
    ...
    public function edit($id)
    {
        ...
        $specials = Special::all();
        return view('admin::dashboard.admins.process.sub_special.edit', compact(['sub_special','specials' ]));
    }
