...
class SpecializationController extends Controller
{
    ...
    public function index()
    {
        ...
        $roles = Role::all();
        return view('admin::dashboard.admins.process.special.index', compact(['specials','roles']));
    }
    ...
    public function edit($id)
    {
        ...
        $roles = Role::all();
        return view('admin::dashboard.admins.process.special.edit', compact(['special','roles']));
    }
