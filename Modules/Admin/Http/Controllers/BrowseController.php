...
class BrowseController extends Controller
{
    ...
    {
        return view('admin::dashboard.admins.Applicants.index');
    }
    ...
    public function pdf($id) {
        ...
        return view('admin::dashboard.users.pdf' , compact(['user', 'expert']));
    ...
    public function Add($request , $sender_id) {
        ...
        // return $request;
         $job = new Job();
            ...
            // $job->level_id = $request->data['level'];
    ...
    public function notfyShow($id){
     ...
     $notfy = \Auth::user()->notifications()
      ...
      return view('admin::dashboard.admins.notifications.show' , compact('notfy'));
    }

    public function notfyAll(){
    //  return \Auth::user()->notifications;
      return view('admin::dashboard.admins.notifications.all');
    }
