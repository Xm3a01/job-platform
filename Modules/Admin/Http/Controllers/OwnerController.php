...
class OwnerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin::dashboard.admins.owners.index', compact('owners'));
    }
    ...
    public function create()
    {
        ...
        return view('admin::dashboard.admins.owners.addNewOwner', compact(['roles' , 'cities','countries']));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin::dashboard.admins.owners.owner_edit',
                                      compact(['owner','roles' ,
                                           'cities','countries']));
    }
