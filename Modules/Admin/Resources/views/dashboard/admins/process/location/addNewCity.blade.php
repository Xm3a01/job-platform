                ...
                <div class="portlet light bordered">
                        <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-dark bold uppercase">  إضافة معلومات المدينة  </span>
                                </div>
                             </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                              <input type="text" class="form-control" placeholder="ادخل  اسم المدينه " name="ar_name">
                                            </div>
                                          </div>
                                          <div class="form-group">
